...
class Solution:
    def minTimeToReach(self, moveTime: List[List[int]]) -> int:
        ...
        minHeap = [(0, 0, 0, 0)]  # Start at (0, 0) with time 0
        ...
        while minHeap:
            currentTime, x, y, odd = heapq.heappop(minHeap)
            ...
            for dx, dy in directions:
                ...
                if 0 <= newX < numRows and 0 <= newY < numCols:
                    ...
                    newArrivalTime = currentTime + 1 + waitTime + odd
                    ...
                    if newArrivalTime < arrivalTime[newX][newY]:
                        ...
                        heapq.heappush(minHeap, (newArrivalTime, newX, newY, odd ^ 1))
